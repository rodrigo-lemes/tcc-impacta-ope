		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					<li class="active treeview"><a href="<c:url value="/index"/>">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="box box-primary">
							...
							<!-- form start -->
							<form:form method="POST" action="salvarAgendamento" id="aform">
								<table>
									<tr>
										<table>
											<tr>
												...
												<td width="50%" id="pad"><form:label path="cliente">Nome do Cliente</form:label>
													...
													<form:select class="form-control" path="cliente"
														id="inputCliente">
									...
									<tr>
										<table>
											<tr>
												<td id="tdFunc"><form:label path="cliente">Nome do Funcionário</form:label>
													<form:select class="form-control" path="funcionario"
														id="inputFuncionario">
												...
												<td id="tdone"><form:label path="servico">Serviço</form:label>
				...
				.ready(
						function() {
							...
							if (status == "Status: 0") {
								...
								window.location.href="/gerenciarAgendamentos";
							}
							if (status == "Status: 1") {
							...
							if (status == "Status: 2") {
								alert("Agendamento não cadastrado!\nJá existem dados iguais no sistema!");
								window.location.href="/gerenciarAgendamentos";
							}
						});
	</script>
