...
<title>Pesquisa de Despesa - EZmalteria</title>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Pesquisa de Despesa</li>
				</ol>
			</section>
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="box box-primary">
							...
							<!-- form start -->
							<form:form method="POST" action="formularioDeEdicaoDespesa"  modelAttribute="command">
								<table>
									<tr>
										<td id="tdone">
										<form:label path="codigo">Código de Despesa</form:label>
										<form:input path="codigo" class="form-control" /></td>
									</tr>
								</table>
								<div class="box-footer">
								  <input type="submit" class="btn btn-primary" value="Buscar Despesa"/>
								</div>
							</form:form>
			            </div>
					</div>
