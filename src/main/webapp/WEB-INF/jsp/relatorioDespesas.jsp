...
<title>Relatório de Despesas - EZmalteria</title>
	      ...
	      <a href="<c:url value="/index"/>">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li><a href="#" class="current"><i class="fa fa-sort-amount-asc"></i> Despesas</a></li>
			  </ul>
            </li>
            <li class="treeview">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Relatório de Despesas</li>
				</ol>
			</section>
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="box box-primary">
							<!-- form start -->
							<form:form action="relatorioDespesas">
								<table>
								  <tr>
								  	<td id="tdone">
							...
							<c:if test="${not empty listaDespesas}">
							  ...
							  <h3>&nbsp;Despesas - ${dataPesquisaInicio} à ${dataPesquisaFim}</h3>
							  <br>
								<table class="bdtable">
								  <tr>
									<td class="topbording fontdb"><b>Código</b></td>
									<td class="topbording fontdb"><b>Descrição</b></td>
									<td class="topbording fontdb"><b>Valor</b></td>
									<td class="topbording fontdb"><b>Tipo</b></td>
									<td class="fontdb"><b>Data</b></td>
								  </tr>
									<!--Popular a lista de objetos no view-->
									<c:forEach var="listValue" items="${listaDespesas}">
										...
										<c:if test="${data>=dataFiltroInicio && data<=dataFiltroFim}">
											<td class="topbording" id="pad"><p align="center">${listValue.codigo}</p></td>
											<c:if test="${not empty listValue.codigo}">
												<c:set var="counter" value="${counter + 1}"/>
											</c:if>
											<td class="topbording" id="pad"><p align="center">${listValue.dsDespesa}</p></td>
											<td class="topbording" id="pad"><p align="center">R$ ${listValue.valor}</p></td>
											<td class="topbording" id="pad"><p align="center">${listValue.tipoDespesa}</p></td>
