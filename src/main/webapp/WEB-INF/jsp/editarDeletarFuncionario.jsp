...
<title>Pesquisa de Funcionário - EZmalteria</title>
			...
			<li class="treeview active">
              <a href="#">
				...
				<ul class="treeview-menu">
					...
					<li><a href="#" class="current"><i class="fa fa-sort-amount-asc"></i>Funcionário</a></li>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Pesquisa de Funcionário</li>
				</ol>
			</section>
						...
						<div class="box box-primary">
							...
							<form:form method="POST" action="formularioDeEdicaoFuncionario"
								...
								<div class="box-footer">
									<input type="submit" class="btn btn-primary" value="Buscar Funcionário" />
								</div>
							</form:form>
						</div>
					</div>
