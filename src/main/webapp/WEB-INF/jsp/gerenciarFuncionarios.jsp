...
<body class="skin-blue">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="box box-primary">
							...
							<!-- form start -->
							<form:form method="POST" action="salvarFuncionarioCadastrado" id="fform">
								<table>
									<tr>
									<table><tr>
							...
							<h3 class="box-title">Dados Pessoais</h3>
								<table>
									...
									<table><tr>
										...
										<form:input path="nome" class="form-control" id="inputNome" required="required"/>
									</td>
									</tr></table>
									</tr>
									<tr>
									<table><tr>
										...
										<form:input path="cpf" class="form-control" id="inputCPF" required="required"/></td>
										<td id="tdtwo"><form:label path="rg">RG <font class="ast">*</font></form:label>
										<form:input path="rg" class="form-control" id="inputRG" required="required"/></td>
									</tr></table>
									</tr>
									<tr>
									<table><tr>
										<td id="tdone"><form:label path="telRes">Telefone Residencial</form:label>
										<form:input path="telRes" class="form-control" id="inputTelRes"/></td>
										<td id="tdone"><form:label path="telCel">Telefone Celular <font class="ast">*</font></form:label>
										<form:input path="telCel" class="form-control" id="inputTelCel" required="required"/></td>
									</tr></table>
									</tr>
									<tr>
									<table><tr>
										<td id="tdtwo"><form:label path="nascimento">Data de Nascimento <font class="ast">*</font></form:label>
										<form:input path="nascimento" class="form-control" id="inputNasc" required="required"/></td>
							...
							<h3 class="box-title">Endereço</h3>
								<table>
									<tr>
									<table><tr>
										<td width="75%" id="pad"><form:label path="logradouro">Logradouro <font class="ast">*</font></form:label>
										<form:input path="logradouro" class="form-control" id="inputLogradouro" required="required"/></td>
										<td width="25%" id="pad"><form:label path="numero">Número <font class="ast">*</font></form:label>
										<form:input path="numero" class="form-control" id="inputLogradouro" required="required"/></td>
									</tr></table>
									</tr>
									<tr>
									<table><tr>
										<td width="37%" id="pad"><form:label path="bairro">Bairro <font class="ast">*</font></form:label>
										<form:input path="cidade" class="form-control" id="inputBairro" required="required"/></td>
										<td width="37%" id="pad"><form:label path="cidade">Cidade <font class="ast">*</font></form:label>
										<form:input path="bairro" class="form-control" id="inputCidade" required="required"/></td>
										<td width="26%" id="pad"><form:label path="uf">UF</form:label>
										<form:select class="form-control" path="uf" id="inputUF">
									...
									<table><tr>
										...
										<form:input path="cep" class="form-control" id="inputCEP" required="required"/></td>
										<td width="65%" id="pad"><form:label path="complemento">Complemento</form:label>
										<form:input path="complemento" class="form-control" id="inputComplemento"/></td>
									</tr></table>
									</tr>
								</table>
							<h3 class="box-title">Dados Trabalhistas</h3>
								<table>
									...
									<table><tr>
										...
										<form:input path="carteiraTrabalho" class="form-control" id="inputCarteiraTrabalho"/></td>
									</tr></table>
									</tr>
									<tr>
									<table><tr>
										<td id="tdone"><form:label path="dataInclusao">Funcionário desde <font class="ast">*</font></form:label>
										<form:input path="dataInclusao" class="form-control" id="inputFuncDesde" required="required"/></td>
										<td id="tdone"><form:label path="salarioFixo">Salário Fixo</form:label>
										<form:input path="salarioFixo" class="form-control" id="inputSalario"/></td>
									</tr></table>
									</tr>
								</table>
							<h3 class="box-title">Perfil de Usuário</h3>
								<table>
									<tr>
									<table><tr>
										<td id="tdtwo"><form:label path="email">E-mail/Usuário <font class="ast">*</font></form:label>
										<form:input path="email" class="form-control" id="inputEmail" required="required"/></td>
										<td id="tdtwo"><form:label path="senha">Senha <font class="ast">*</font></form:label>
										<form:input path="senha" class="form-control" id="inputSenha" required="required"/></td>
	...
	$(document).ready(function(){
		...
		if(status == "Status: 0"){
			...
			window.location.href="/gerenciarFuncionarios";
		}
		if(status == "Status: 1"){
