...
<body class="skin-blue">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#" class="current"> <i
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="box box-primary">
							...
							<form:form method="POST" action="salvarServicoRealizado"
								id="sform">
								<table>
									<tr>
										<table>
											<tr>
												<td width="50%" id="pad"><form:label path="nomeCliente">Nome do Cliente</form:label>

													<form:select class="form-control" path="nomeCliente"
														id="inputCliente">

														<c:forEach var="listValue" items="${nomesClientes}">
									...
									<tr>
										<table>
											<tr>
												<td id="tdFunc"><form:label path="nomeFuncionario">Nome do Funcionário</form:label>
													<form:select class="form-control" path="nomeFuncionario"
														id="inputFuncionario">

														<c:forEach var="listValue" items="${nomesFuncionarios}">
															<form:option value="${listValue}">${listValue}</form:option>
														</c:forEach>
													</form:select></td>
												<td width="35%" id="pad"><form:label
														path="tipoFuncionario">Tipo</form:label> <form:select
														class="form-control" path="tipoFuncionario">
									...
									<tr>
										<table>
											<tr>
												<td width="40%" id="pad"><form:label
														path="dataInclusao">Data <font class="ast">*</font></form:label> <form:input
														path="dataInclusao" class="form-control" id="inputData"
														required="required" /></td>
												<td width="40%" id="pad"><form:label path="comanda">Número de Comanda <font class="ast">*</font></form:label>
													<form:input path="comanda" class="form-control"
														id="inputComanda" required="required" /></td>
	...
	<!--Máscaras-->
	<script src="<c:url value="/resources/plugins/jquery.maskMoney.js"/>"
		type="text/javascript" /></script>
	<script type="text/javascript">
		$(document).ready(function() {
			$("#inputManicurePreco").maskMoney({
				prefix : 'R$ ',
				allowNegative : true,
				thousands : '.',
				decimal : ',',
			...
			$("#inputFrancesinhaPreco").maskMoney({
				prefix : 'R$ ',
				allowNegative : true,
				thousands : '.',
				decimal : ',',
			...
			$("#inputSobrancelhaPreco").maskMoney({
				prefix : 'R$ ',
				allowNegative : true,
				thousands : '.',
				decimal : ',',
	...
	<script>
		$(document).ready(function() {
			...
			if (status == "Status: 0") {
				...
				window.location.href = "/gerenciarServicosRealizados";
			}
			if (status == "Status: 1") {
