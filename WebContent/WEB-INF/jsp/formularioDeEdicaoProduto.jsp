						...
						<div class="box box-primary">
							...
							<script>
								function submitForm(clickedButton) {
									if (clickedButton.name == "deletarProduto") {
										formSalvarProdutoEditado.action = "deletarProduto";
									}
									if(confirm("Deseja deletar este produto?")){
										formSalvarProdutoEditado.submit();
									}
								}
							</script>
							
							<form:form name="formSalvarProdutoEditado" method="POST" action="salvarProdutoEditado" id="pform">
								<table>
								  <tr>
									<table><tr>
									<td width="38%" id="pad">
							...
							<div class="box-footer">
							  ...
							  <input type="button"
									class="btn btn-primary" name="deletarProduto"
									value="Deletar Produto" onClick=submitForm(this) />
							...
							if(${insertResult}==""){
								if(document.getElementByid("inputProduto").value==""){
									...
									window.location.href="/editarDeletarProduto";
								}
							}else{
