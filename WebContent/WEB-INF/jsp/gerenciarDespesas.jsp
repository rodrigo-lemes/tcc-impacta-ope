...
<body class="skin-blue">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="box box-primary">
							...
							<!-- form start -->
							<form:form method="POST" action="salvarDespesa" id="dform">
								<table>
									<tr>
										<table>
											<tr>
												<td id="tdone"><form:label path="codigo">Código <font class="ast">*</font></form:label>
													<form:input path="codigo" class="form-control"
														id="inputCodigo" required="required" /></td>
												<td id="tdone"><form:label path="tipoDespesa">Grupo</form:label>
													<form:select class="form-control" path="tipoDespesa"
														id="inputGrupo">
														<form:option value="deposito">Depósito</form:option>
														<form:option value="variaveis">Despesas Variáveis</form:option>
														<form:option value="equipamento">Equipamento</form:option>
														<form:option value="imovel">Imóvel</form:option>
														<form:option value="imposto">Imposto</form:option>
														<form:option value="maodeobra">Mão de Obra</form:option>
														<form:option value="materiaprima">Matéria Prima</form:option>
													</form:select></td>
												</td>
											</tr>
										</table>
										...
										<table>
											<tr>
												<td id="tdone"><form:label path="dsDespesa">Despesa <font class="ast">*</font></form:label>
													<form:input path="dsDespesa" class="form-control"
														id="inputDespesa" required="required" /></td>
											</tr>
										</table>
									</tr>
									<tr>
										<table>
											<tr>
												<td id="tdone"><form:label path="valor">Preço <font class="ast">*</font></form:label>
													<form:input path="valor" class="form-control"
														id="inputPreco" required="required" /></td>
												<td id="tdone"><form:label path="dataInclusao">Data de Inclusão <font class="ast">*</font></form:label>
													<form:input path="dataInclusao" class="form-control"
														id="inputData" required="required" /></td>
											</tr>
										</table>
									</tr>
								</table>
	...
	$(document).ready(function(){
		...
		if(status == "Status: 0"){
			...
			window.location.href="/gerenciarDespesas";
		}
		if(status == "Status: 1"){
